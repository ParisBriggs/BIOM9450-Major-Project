...
<body>
    ...
    <div class="container">
        ...
        <div class="right-column">
            ...
            <button onclick="location.href='patient_info.php'">Add / Edit Patient Information</button>
            <button onclick="location.href='dispensing_history.php'">View Dispensing History</button>
        </div>
    </div>
